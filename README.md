...
<table>
  <tr>
    <td width="33%"><img src="docs/images/quotabar-accounts.png" alt="Compact Accounts view with one row per Claude or Codex account"></td>
    <td width="33%"><img src="docs/images/quotabar-limit-types.png" alt="Compact limit-types view grouping one-row account summaries by five-hour, weekly, and Fable limits"></td>
    <td width="33%"><img src="docs/images/quotabar-settings.png" alt="Settings view with browser OAuth sign-in and Keychain-only security notes"></td>
  </tr>
  <tr>
    <td align="center"><sub>Compact accounts view</sub></td>
    <td align="center"><sub>Compact limit types view</sub></td>
    <td align="center"><sub>Settings and OAuth view</sub></td>
  </tr>
</table>
